 ...
 **/
@Data
public class InputOrganizationUpdateDTO {

    @Check(empty = false,description = "")
    private Long  id;
     ...
     * 注册资本
     */
    @Check(empty = false, regexType = RegexType.NUMBER,description = "注册资本")
     ...
     *
     */
    @Check(empty = false,regexType = RegexType.PHONENUMBER,description = "联系电话")
