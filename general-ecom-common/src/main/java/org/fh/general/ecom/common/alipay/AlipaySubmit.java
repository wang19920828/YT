package org.fh.general.ecom.common.alipay;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName,String alipayKey) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp,alipayKey);
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "input=query_timestamp&partner=" + AlipayConfig.partner + "&_input_charset" +AlipayConfig.input_charset;
