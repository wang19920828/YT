...
public class ProjectProgrammeServiceImpl extends ServiceImpl<ProjectProgrammeDao, ProjectProgramme> implements ProjectProgrammeService {
    ...
    public ProjectProgrammeListOutputPO findById(Long id){
        ProjectProgrammeListOutputPO outputPO=new ProjectProgrammeListOutputPO();
        ProjectProgramme projectProgramme =  this.baseMapper.selectById(id);
        if(projectProgramme!=null){
            BeanUtils.copyProperties(projectProgramme,outputPO);
            OutputProjectMainInfoDTO outputProjectMainInfoDTO = projectService.findMainInfoByProjectId(projectProgramme.getProjectId()+"");
            if(outputProjectMainInfoDTO!=null) {
                outputPO.setProjectName(outputProjectMainInfoDTO.getProjectName());
            }
