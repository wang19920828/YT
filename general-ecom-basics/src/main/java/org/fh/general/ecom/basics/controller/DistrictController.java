...
public class DistrictController {
	...
	@RequestMapping("DIST80002")
	public BaseVO findOneLevelList(){
		BaseVO baseVo=new BaseVO();
		DistrictPageDTO response = this.districtService.findOneLevelList();
		if(response==null || response.getList()==null || response.getList().size()==0){
			baseVo.noData();
			return baseVo;
		}
	...
	public String findbySortCode(@RequestBody  String  code){
		String name = 	this.districtService.findBySortCode(code);
		return name;
	}
}
